          ...
          <TabsContent value="projects" className="pt-6 pb-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 ">
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Crea una app que ayude a prevenir enfermedades o que facilite las citas médicas en zonas rurales.
                    ¡Usa la IA para hacer recomendaciones personalizadas!
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Desarrolla una plataforma de aprendizaje que use IA para adaptar las lecciones según las necesidades
                    de cada estudiante. ¡Haz que aprender sea divertido!
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Crea una app que ayude a personas con discapacidades, como un traductor de texto a lenguaje de señas
                    o un navegador para personas con dificultades visuales.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Desarrolla una app que use IA para predecir y alertar sobre fenómenos climáticos extremos o que
                    ayude a las personas a reducir su huella de carbono.
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Crea un sistema que use IA para ayudar a prevenir accidentes o situaciones de riesgo en tu escuela o
                    comunidad. ¡La tecnología puede salvar vidas!
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Diseña una plataforma para conectar voluntarios con organizaciones que necesiten ayuda. ¡Usa la IA
                    para hacer las mejores conexiones entre personas!
                  </CardDescription>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-900 border-violet-200 dark:border-violet-800 overflow-hidden hover:shadow-lg transition-all hover:-translate-y-1">
                ...
                <CardContent>
                  <CardDescription className="text-base text-slate-700 dark:text-slate-300">
                    Crea una app que ayude a los jóvenes a descubrir sus talentos y encontrar oportunidades de estudio o
                    trabajo que se adapten a sus habilidades e intereses.
                  </CardDescription>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="grid md:grid-cols-[2fr,3fr] gap-8 items-center">
            ...
            <div className="flex flex-col items-center text-center md:items-start md:text-left space-y-4">
              ...
              <div className="flex gap-4">
                ...
                >
                  <Link href="https://www.linkedin.com/in/daniel-dur%C3%A1n-6788382b7/" className="flex items-center gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
            ...
            <div className="bg-white/50 dark:bg-slate-800/50 rounded-2xl p-6 space-y-6 shadow-lg backdrop-blur-sm border border-violet-100 dark:border-violet-800">
              <div className="space-y-4">
                ...
                <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                  Apasionado por la programación web y la innovación tecnológica. Como Full Stack Developer en Subcargo,
                  me especializo en crear soluciones robustas y escalables que combinan lo mejor del desarrollo frontend
                  y backend.
                </p>
              </div>
